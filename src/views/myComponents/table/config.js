export const USER_CONFIG = {
    gridConfig: [
      {label: '科室代码', prop: 'code'},
      {label: '科室名称', prop: 'name'},
      {label: '科室类型', prop: 'officeType'},
      // {
    ...
    formConfig: [
      {span: 12, label: '科室代码', prop: 'code', type: 'text'},
      {span: 12, label: '科室名称', prop: 'name', type: 'text'},
      {span: 12, label: '科室类型', prop: 'officeType', type: 'text'},],
    //   {
    //     span: 12, label: '角色',
    //     prop: 'roleIdList',
    //     type: 'checkbox',
